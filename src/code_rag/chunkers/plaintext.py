"""
Plaintext chunker: fallback line-based chunker for files without AST support or
markdown structure. Splits at blank-line paragraph boundaries with min/max size
enforcement. Used as the registry fallback for any unclaimed extension.
"""
...
class PlaintextChunker(BaseChunker):
    """Paragraph-boundary chunker; the registry's catch-all fallback."""

    def supported_extensions(self) -> set[str]:
        # Registered as the fallback rather than for specific extensions.
        return set()
